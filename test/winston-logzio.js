...
describe('winston-logzio', function () {
    ...
    describe('send json as log message', function () {
        it('builds the log object as json properly', function (done) {
            const logzioWinstonTransport = new LogzioWinstonTransport({
                level: 'info',
                name: 'logger1',
                token: '_API_TOKEN_'
    ...
    describe('send json as log message without error', function () {
        it('builds the log object with just a message object', function (done) {
            const logzioWinstonTransport = new LogzioWinstonTransport({
                level: 'info',
                name: 'logger1',
                token: '_API_TOKEN_'
